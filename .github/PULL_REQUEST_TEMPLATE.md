...
- [ ] Entidades o el modelo de datos → corrí `yarn orm:catalog && yarn orm:gen && yarn orm:audit` y actualicé `docs/data/entity-catalog.md` con `yarn docs:data:sync` si aplica.
