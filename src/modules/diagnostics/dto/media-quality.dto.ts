...
export class MediaAnnotationItemDto {
  @ApiPropertyOptional({ format: 'uuid', description: 'Tipo de anotación (concept id)' })
  @IsOptional()
  @IsUUID()
...
export class AttachClinicalMediaDto {
  ...
  @ApiProperty({ format: 'uuid', description: 'Archivo ya cargado (common.files)' })
  @IsUUID()
  fileId!: string;
  ...
  @ApiPropertyOptional({ format: 'uuid', description: 'Tipo de media (concept id)' })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({ format: 'uuid', description: 'Vista/proyección (concept id)' })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({ format: 'uuid', description: 'Informe diagnóstico al que se adjunta' })
  @IsOptional()
  @IsUUID()
  diagnosticReportId?: string;

  @ApiPropertyOptional({ format: 'uuid', description: 'Visibilidad al paciente (concept id)' })
  @IsOptional()
  @IsUUID()
  patientVisibilityConceptId?: string;

  @ApiPropertyOptional({ format: 'uuid', description: 'Profesional que captura' })
  @IsOptional()
  @IsUUID()
  capturedByProfileId?: string;

  @ApiPropertyOptional({ type: [MediaAnnotationItemDto], description: 'Anotaciones IA/manual' })
  @IsOptional()
  @IsArray()
...
export class CreateDataQualityEventDto {
  @ApiProperty({ format: 'uuid', description: 'Id del objetivo (specimen/observation/study)' })
  @IsUUID()
  targetId!: string;
  ...
  @ApiPropertyOptional({ format: 'uuid', description: 'Tipo de objetivo (concept id)' })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({ format: 'uuid', description: 'Id de la fuente para enlazar provenance' })
  @IsOptional()
  @IsUUID()
  provenanceSourceId?: string;

  @ApiPropertyOptional({ format: 'uuid', description: 'Tipo de fuente de provenance (concept id)' })
  @IsOptional()
  @IsUUID()
  provenanceSourceTypeConceptId?: string;

  @ApiPropertyOptional({ format: 'uuid', description: 'Profesional/agente de la derivación' })
  @IsOptional()
  @IsUUID()
