 ...
 */
export const { seeds: AUTHZ_CONCEPT_SEEDS, ids: AUTHZ } = defineModuleConcepts(
  'authz',
  {
    ...
    PURPOSE_EMERGENCY: {
      code: 'EMERGENCY',
      display: 'Emergency (break-the-glass)',
    },
    ...
    ACCESS_LEVEL_ELEVATED: {
      code: 'ACCESS_ELEVATED',
      display: 'Elevated (emergency) access',
    },
    ...
    SUBJECT_TYPE_SERVICE: {
      code: 'SUBJECT_SERVICE',
      display: 'Service principal subject',
    },
    ...
    RESOURCE_TYPE_DOCUMENT: {
      code: 'RES_DOCUMENT',
      display: 'Document resource',
    },
    RESOURCE_TYPE_RECORD: {
      code: 'RES_RECORD',
      display: 'Clinical record resource',
    },

    // --- Rol base (roles.base_role_concept_id) ---
    BASE_ROLE_CLINICAL: {
      code: 'BASE_CLINICAL',
      display: 'Clinical base role',
    },
    BASE_ROLE_ADMIN: {
      code: 'BASE_ADMIN',
      display: 'Administrative base role',
    },
    ...
    BG_REVIEW_JUSTIFIED: {
      code: 'BG_JUSTIFIED',
      display: 'Break-the-glass justified',
    },
    BG_REVIEW_UNJUSTIFIED: {
      code: 'BG_UNJUSTIFIED',
