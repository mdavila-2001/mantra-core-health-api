...
/**
 * Mapea la entidad persistente asociada a `custom_conversions`.
 */
...
export class CustomConversions {
  ...
  /**
   * Identificador asociado a conversion category concept.
   */
  ...
  /**
   * Valor de default value mantenido por la instancia.
   */
  @Property({
