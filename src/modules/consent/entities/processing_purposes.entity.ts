...
@Entity({ schema: 'consent', tableName: 'processing_purposes' })
export class ProcessingPurposes {
  ...
  @Property({
    fieldName: 'default_retention_class_concept_id',
    type: 'uuid',
    nullable: true,
  }) // FK → terminology.catalog_concepts
  defaultRetentionClassConceptId?: string;
