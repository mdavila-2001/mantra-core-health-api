...
/**
 * Mapea la entidad persistente asociada a `remediation_plans`.
 */
@Entity({ schema: 'system_ops', tableName: 'remediation_plans' })
export class RemediationPlans {
  /**
   ...
   */
  @Property({
    fieldName: 'target_completion_at',
