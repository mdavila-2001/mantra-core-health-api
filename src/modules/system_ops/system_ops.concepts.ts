 ...
 */
export const { seeds: SYSTEM_OPS_CONCEPT_SEEDS, ids: SYSOPS } =
  defineModuleConcepts('system_ops', {
    ...
    ACTION_RELEASE: {
      code: 'SO_ACTION_RELEASE',
      display: 'Governance release',
    },
    ...
    WRITE_MODE_APPEND_ONLY: {
      code: 'SO_WRITE_APPEND_ONLY',
      display: 'Append only',
    },
    WRITE_MODE_SOFT_DELETE: {
      code: 'SO_WRITE_SOFT_DELETE',
      display: 'Soft delete only',
    },
    ...
    LEGAL_BASIS_LEGAL_OBLIGATION: {
      code: 'SO_LB_LEGAL_OBLIGATION',
      display: 'Legal obligation',
    },
    DISPOSITION_DELETE: { code: 'SO_DISP_DELETE', display: 'Delete on expiry' },
    DISPOSITION_ANONYMIZE: {
      code: 'SO_DISP_ANONYMIZE',
      display: 'Anonymize on expiry',
    },
    DISPOSITION_ARCHIVE: {
      code: 'SO_DISP_ARCHIVE',
      display: 'Archive on expiry',
    },
    ...
    TECHNIQUE_PSEUDONYMIZE: {
      code: 'SO_TECH_PSEUDONYMIZE',
    ...
    EXEC_SUCCEEDED: {
      code: 'SO_EXEC_SUCCEEDED',
      display: 'Retention run succeeded',
    },
    ...
    REGION_SA_EAST: {
      code: 'SO_REGION_SA_EAST',
      display: 'South America East',
    },
    ...
    DATA_CATEGORY_PHI: {
      code: 'SO_DATA_CAT_PHI',
      display: 'Protected health information',
    },
    DATA_CATEGORY_PII: { code: 'SO_DATA_CAT_PII', display: 'Personal data' },
    TRANSFER_BASIS_SCC: {
      code: 'SO_TRANSFER_SCC',
      display: 'Standard contractual clauses',
    },
    TRANSFER_BASIS_ADEQUACY: {
      code: 'SO_TRANSFER_ADEQUACY',
      display: 'Adequacy decision',
    },

    // --- Legal hold (legal_holds.target_type / reason) ---
    HOLD_TARGET_TABLE: {
      code: 'SO_HOLD_TARGET_TABLE',
      display: 'Table target',
    },
    HOLD_TARGET_RECORD: {
      code: 'SO_HOLD_TARGET_RECORD',
      display: 'Record target',
    },
    HOLD_REASON_LITIGATION: {
      code: 'SO_HOLD_REASON_LITIGATION',
      display: 'Litigation hold',
    },
    HOLD_REASON_INVESTIGATION: {
      code: 'SO_HOLD_REASON_INVESTIGATION',
      display: 'Investigation hold',
    },

    // --- Backup (backup_policies.resource_scope / backup_type) ---
    BACKUP_SCOPE_DATABASE: {
      code: 'SO_BACKUP_SCOPE_DB',
      display: 'Database scope',
    },
    BACKUP_SCOPE_OBJECT_STORE: {
      code: 'SO_BACKUP_SCOPE_OBJ',
      display: 'Object storage scope',
    },
    BACKUP_TYPE_FULL: { code: 'SO_BACKUP_TYPE_FULL', display: 'Full backup' },
    BACKUP_TYPE_INCREMENTAL: {
      code: 'SO_BACKUP_TYPE_INCR',
      display: 'Incremental backup',
    },

    // --- Prueba de restauración (restore_test_runs.outcome_concept_id) ---
    RESTORE_OUTCOME_PASS: {
      code: 'SO_RESTORE_PASS',
      display: 'Restore test passed',
    },
    RESTORE_OUTCOME_FAIL: {
      code: 'SO_RESTORE_FAIL',
      display: 'Restore test failed',
    },

    // --- Framework operativo (operational_frameworks.provider / controls.pillar) ---
    FRAMEWORK_PROVIDER_INTERNAL: {
      code: 'SO_FW_PROVIDER_INTERNAL',
      display: 'Internal framework provider',
    },
    FRAMEWORK_PROVIDER_AWS: {
      code: 'SO_FW_PROVIDER_AWS',
      display: 'AWS framework provider',
    },
    PILLAR_SECURITY: { code: 'SO_PILLAR_SECURITY', display: 'Security pillar' },
    PILLAR_RELIABILITY: {
      code: 'SO_PILLAR_RELIABILITY',
      display: 'Reliability pillar',
    },

    // --- Evaluación de workload (workload_assessments.assessment_type / status) ---
    ASSESS_TYPE_SELF: {
      code: 'SO_ASSESS_TYPE_SELF',
      display: 'Self assessment',
    },
    ASSESS_TYPE_AUDIT: {
      code: 'SO_ASSESS_TYPE_AUDIT',
      display: 'Audit assessment',
    },
    ASSESS_IN_PROGRESS: {
      code: 'SO_ASSESS_IN_PROGRESS',
      display: 'Assessment in progress',
    },
    ASSESS_COMPLETED: {
      code: 'SO_ASSESS_COMPLETED',
      display: 'Assessment completed',
    },
    ...
    RESULT_PARTIAL: {
      code: 'SO_RESULT_PARTIAL',
      display: 'Control partially met',
    },
    MATURITY_INITIAL: {
      code: 'SO_MATURITY_INITIAL',
      display: 'Maturity: initial',
    },
    MATURITY_MANAGED: {
      code: 'SO_MATURITY_MANAGED',
      display: 'Maturity: managed',
    },
    MATURITY_OPTIMIZED: {
      code: 'SO_MATURITY_OPTIMIZED',
      display: 'Maturity: optimized',
    },
    ...
    PLAN_COMPLETED: {
      code: 'SO_PLAN_COMPLETED',
      display: 'Remediation plan completed',
    },
    ACTION_OPEN: { code: 'SO_RA_OPEN', display: 'Remediation action open' },
    ACTION_IN_PROGRESS: {
      code: 'SO_RA_IN_PROGRESS',
      display: 'Remediation action in progress',
    },
    ACTION_DONE: { code: 'SO_RA_DONE', display: 'Remediation action done' },
    ACTION_VERIFIED: {
      code: 'SO_RA_VERIFIED',
      display: 'Remediation action verified',
    },
