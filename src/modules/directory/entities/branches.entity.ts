...
/**
 * Mapea la entidad persistente asociada a `branches`.
 */
@Entity({ schema: 'directory', tableName: 'branches' })
export class Branches {
   ...
   */
  @Property({ fieldName: 'branch_type_concept_id', type: 'uuid' }) // FK → terminology.catalog_concepts
