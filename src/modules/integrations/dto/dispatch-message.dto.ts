...
export class DispatchMessageDto {
  @ApiPropertyOptional({
    description: 'Si true, el envío se marca como FAILED (para reintentos)',
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Código HTTP devuelto por el proveedor',
    minimum: 100,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Detalle del error cuando falla',
    maxLength: 2000,
  })
  @IsOptional()
  @IsString()
