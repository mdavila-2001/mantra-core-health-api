 ...
 * aquí).
 */
export const { seeds: BILLING_CONCEPT_SEEDS, ids: BILL } = defineModuleConcepts(
  'billing',
  {
    ...
    INVOICE_PARTIALLY_PAID: {
      code: 'INV_PARTIALLY_PAID',
      display: 'Invoice partially paid',
    },
    ...
    INVOICE_IN_COLLECTION: {
      code: 'INV_IN_COLLECTION',
      display: 'Invoice in collection',
    },
    INVOICE_PAYMENT_PLAN: {
      code: 'INV_PAYMENT_PLAN',
      display: 'Invoice under payment plan',
    },
    ...
    BILL_PARTIALLY_PAID: {
      code: 'BILL_PARTIALLY_PAID',
      display: 'Bill partially paid',
    },
    ...
    REL_ENCOUNTER_OF: {
      code: 'REL_ENCOUNTER_OF',
      display: 'Invoice of encounter',
    },
    REL_CREDIT_OF: { code: 'REL_CREDIT_OF', display: 'Credit of invoice' },
    REL_REIMBURSEMENT_OF: {
      code: 'REL_REIMBURSEMENT_OF',
      display: 'Reimbursement of invoice',
    },
    REL_STATEMENT_INCLUDES: {
      code: 'REL_STATEMENT_INCLUDES',
      display: 'Statement includes invoice',
    },
    REL_INSTALLMENT_OF: {
      code: 'REL_INSTALLMENT_OF',
      display: 'Installment of invoice',
    },

    // --- Reembolsos de seguro (billing.reimbursements.status_concept_id) ---
    REIMBURSEMENT_POSTED: {
      code: 'REIMB_POSTED',
      display: 'Reimbursement posted',
    },

    // --- Morosidad (billing.dunning_runs/items) ---
    DUNNING_RUN_RUNNING: {
      code: 'DUN_RUN_RUNNING',
      display: 'Dunning run running',
    },
    DUNNING_RUN_COMPLETED: {
      code: 'DUN_RUN_COMPLETED',
      display: 'Dunning run completed',
    },
    DUNNING_ITEM_NOTIFIED: {
      code: 'DUN_ITEM_NOTIFIED',
      display: 'Dunning notice issued',
    },
