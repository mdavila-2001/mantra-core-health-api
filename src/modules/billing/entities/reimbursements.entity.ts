...
/**
 * Mapea la entidad persistente asociada a `reimbursements`.
 */
@Entity({ schema: 'billing', tableName: 'reimbursements' })
export class Reimbursements {
   ...
   */
  @Property({ fieldName: 'claim_id', type: 'uuid' }) // FK (destino no resuelto)
  claimId!: string;
