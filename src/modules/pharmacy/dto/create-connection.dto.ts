...
export class CreateConnectionDto {
  @ApiProperty({ description: 'Modo de integración', enum: ['REALTIME', 'BATCH'] })
  @IsIn(['REALTIME', 'BATCH'])
  integrationMode!: IntegrationModeCode;

  @ApiPropertyOptional({
    description: 'Conexión de integración externa registrada; si se omite, la fila se auto-referencia',
    format: 'uuid',
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({ description: 'Sede a la que aplica la conexión', format: 'uuid' })
  @IsOptional()
  @IsUUID()
  pharmacySiteId?: string;

  @ApiPropertyOptional({ description: 'Concept id de la autoridad de inventario', format: 'uuid' })
  @IsOptional()
  @IsUUID()
