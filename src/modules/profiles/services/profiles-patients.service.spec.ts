...
describe('ProfilesPatientsService', () => {
  ...
  describe('getOwnProfile', () => {
    ...
    it('los seguros vuelven tal como los resuelve DeclaredCoveragesReader', async () => {
      // La consulta SQL, el prefijo de moneda y el lote de beneficios se
