 ...
 */
export const { seeds: ACCOUNTING_CONCEPT_SEEDS, ids: ACCT } =
  defineModuleConcepts('accounting', {
    // --- Tipos de transacción (journal_transactions.transaction_type_concept_id) ---
    TXN_TYPE_STANDARD: {
      code: 'ACCT_TXN_STANDARD',
      display: 'Standard journal entry',
    },
    TXN_TYPE_REVERSAL: {
      code: 'ACCT_TXN_REVERSAL',
      display: 'Reversal journal entry',
    },
    TXN_TYPE_ACCRUAL: { code: 'ACCT_TXN_ACCRUAL', display: 'Accrual posting' },
    TXN_TYPE_DEPRECIATION: {
      code: 'ACCT_TXN_DEPRECIATION',
      display: 'Depreciation posting',
    },
    TXN_TYPE_CLEARING: {
      code: 'ACCT_TXN_CLEARING',
      display: 'Clearing posting',
    },
    TXN_TYPE_ASSET_ACQUISITION: {
      code: 'ACCT_TXN_ASSET_ACQ',
      display: 'Asset acquisition posting',
    },
    TXN_TYPE_LIABILITY_PAYMENT: {
      code: 'ACCT_TXN_LIAB_PAY',
      display: 'Liability payment posting',
    },
    ...
    ACCOUNT_TYPE_LIABILITY: {
      code: 'ACCT_ACC_LIABILITY',
      display: 'Liability account',
    },
    ACCOUNT_TYPE_EQUITY: { code: 'ACCT_ACC_EQUITY', display: 'Equity account' },
    ACCOUNT_TYPE_REVENUE: {
      code: 'ACCT_ACC_REVENUE',
      display: 'Revenue account',
    },
    ACCOUNT_TYPE_EXPENSE: {
      code: 'ACCT_ACC_EXPENSE',
    ...
    ACCRUAL_TYPE_DEFAULT: {
      code: 'ACCT_ACCRUAL_DEFAULT',
      display: 'Default accrual type',
    },
    ACCRUAL_ACTIVE: {
      code: 'ACCT_ACCRUAL_ACTIVE',
      display: 'Accrual object active',
    },
    SCHEDULE_PENDING: {
      code: 'ACCT_ACCRUAL_LINE_PENDING',
      display: 'Accrual schedule line pending',
    },
    SCHEDULE_POSTED: {
      code: 'ACCT_ACCRUAL_LINE_POSTED',
      display: 'Accrual schedule line posted',
    },

    // --- Subledgers y partidas abiertas (subledger_accounts / open_items) ---
    SUBLEDGER_CUSTOMER: {
      code: 'ACCT_SL_CUSTOMER',
      display: 'Customer subledger role',
    },
    SUBLEDGER_VENDOR: {
      code: 'ACCT_SL_VENDOR',
      display: 'Vendor subledger role',
    },
    SUBLEDGER_ACTIVE: {
      code: 'ACCT_SL_ACTIVE',
      display: 'Subledger account active',
    },
    ...
    OPEN_ITEM_PARTIAL: {
      code: 'ACCT_OI_PARTIAL',
      display: 'Open item partially cleared',
    },
    OPEN_ITEM_CLEARED: {
      code: 'ACCT_OI_CLEARED',
      display: 'Open item cleared',
    },

    // --- Clearing y vínculos entre documentos (clearing_documents / accounting_document_links) ---
    CLEARING_COMPLETED: {
      code: 'ACCT_CLR_COMPLETED',
      display: 'Clearing completed',
    },
    ...
    ASSET_TYPE_EQUIPMENT: {
      code: 'ACCT_ASSET_EQUIPMENT',
      display: 'Equipment asset',
    },
    DEPRECIATION_METHOD_STRAIGHT_LINE: {
      code: 'ACCT_DEP_STRAIGHT_LINE',
      display: 'Straight-line depreciation',
    },
    ASSET_POSTING_ACQUISITION: {
      code: 'ACCT_ASSET_POST_ACQ',
      display: 'Asset acquisition',
    },
    ASSET_POSTING_DEPRECIATION: {
      code: 'ACCT_ASSET_POST_DEP',
      display: 'Asset depreciation',
    },
    ...
    LIABILITY_SETTLED: {
      code: 'ACCT_LIAB_SETTLED',
      display: 'Liability settled',
    },
    LIAB_SCHEDULE_PENDING: {
      code: 'ACCT_LIAB_SCHED_PENDING',
      display: 'Liability installment pending',
    },
    LIAB_SCHEDULE_PAID: {
      code: 'ACCT_LIAB_SCHED_PAID',
      display: 'Liability installment paid',
    },
    COMPONENT_PRINCIPAL: {
      code: 'ACCT_COMP_PRINCIPAL',
      display: 'Principal component',
    },
    COMPONENT_INTEREST: {
      code: 'ACCT_COMP_INTEREST',
      display: 'Interest component',
    },

    // --- Determinación de cuentas (account_determination_rules) ---
    RULE_ACTIVE: {
      code: 'ACCT_RULE_ACTIVE',
      display: 'Determination rule active',
    },
    SCENARIO_ASSET_ACQUISITION: {
      code: 'ACCT_SCN_ASSET_ACQ',
      display: 'Asset acquisition scenario',
    },
    ROLE_ACQUISITION_ACCOUNT: {
      code: 'ACCT_ROLE_ACQ_ACCOUNT',
      display: 'Acquisition account role',
    },
