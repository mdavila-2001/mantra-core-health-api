...
export class AdvanceCursorDto {
  @ApiProperty({ description: 'Nuevo valor del cursor (debe avanzar hacia adelante)', maxLength: 4096 })
  @IsString()
  @MinLength(1)
  @MaxLength(4096)
  cursorValue!: string;
  ...
  @ApiPropertyOptional({ description: 'Último intercambio exitoso que valida el avance', format: 'uuid' })
  @IsOptional()
  @IsUUID()
