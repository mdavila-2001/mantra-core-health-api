...
export class ServiceReviews {
  ...
  @Property({ fieldName: 'verified_encounter_id', type: 'uuid', nullable: true })  // FK → clinical.encounters
  ...
  @Property({ fieldName: 'reviewer_display_mode_concept_id', type: 'uuid', nullable: true })  // FK → terminology.catalog_concepts
