 ...
 */
export const { seeds: GEO_CONCEPT_SEEDS, ids: GEO } = defineModuleConcepts('geo', {
  // --- Tipo de sujeto rastreado (tracked_subjects.subject_type_concept_id) ---
  SUBJECT_TYPE_PERSON: { code: 'GEO_SUBJECT_TYPE_PERSON', display: 'Tracked person' },
  SUBJECT_TYPE_VEHICLE: { code: 'GEO_SUBJECT_TYPE_VEHICLE', display: 'Tracked vehicle' },

  // --- Estado del sujeto rastreado (tracked_subjects.state_concept_id) ---
  SUBJECT_ACTIVE: { code: 'GEO_SUBJECT_ACTIVE', display: 'Tracked subject active' },
  SUBJECT_SUSPENDED: { code: 'GEO_SUBJECT_SUSPENDED', display: 'Tracked subject suspended' },

  // --- Estado de la sesión de tracking (tracking_sessions.status_concept_id) ---
  SESSION_OPEN: { code: 'GEO_SESSION_OPEN', display: 'Tracking session open' },
  SESSION_CLOSED: { code: 'GEO_SESSION_CLOSED', display: 'Tracking session closed' },

  // --- Propósito de la sesión (tracking_sessions.purpose_concept_id) ---
  SESSION_PURPOSE_DISPATCH: { code: 'GEO_SESSION_PURPOSE_DISPATCH', display: 'Dispatch tracking' },
  ...
  GEOFENCE_ACTIVE: { code: 'GEO_GEOFENCE_ACTIVE', display: 'Geofence active' },
