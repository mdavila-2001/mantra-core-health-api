...
export class VerifyIntegrityDto {
  @ApiPropertyOptional({ description: 'Partición de tenant a verificar', format: 'uuid' })
  @IsOptional()
  @IsUUID()
  tenantId?: string;

  @ApiPropertyOptional({ description: 'Máximo de eslabones a recorrer', default: 1000 })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  @Min(1)
...
export class IntegrityReportDto {
  ...
  @ApiProperty({ description: 'Id del primer eslabón roto, si lo hay', nullable: true })
