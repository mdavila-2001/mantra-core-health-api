...
/**
 * Mapea la entidad persistente asociada a `coupons_history`.
 */
@Entity({ schema: 'audit', tableName: 'coupons_history' })
export class CouponsHistory {
  /**
  ...
  /**
   * Identificador asociado a coupons.
   */
  @Property({ fieldName: 'coupons_id', type: 'uuid' }) // FK → promotions.coupons
  couponsId!: string;
