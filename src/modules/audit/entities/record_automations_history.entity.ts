...
/**
 * Mapea la entidad persistente asociada a `record_automations_history`.
 */
@Entity({ schema: 'audit', tableName: 'record_automations_history' })
export class RecordAutomationsHistory {
  /**
  ...
  /**
   * Identificador asociado a record automations.
   */
  @Property({ fieldName: 'record_automations_id', type: 'uuid' }) // FK → automation.record_automations
  recordAutomationsId!: string;
