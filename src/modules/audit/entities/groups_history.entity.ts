...
/**
 * Mapea la entidad persistente asociada a `groups_history`.
 */
@Entity({ schema: 'audit', tableName: 'groups_history' })
export class GroupsHistory {
  /**
  ...
  /**
   * Identificador asociado a groups.
   */
  @Property({ fieldName: 'groups_id', type: 'uuid' }) // FK → community.groups
  groupsId!: string;
