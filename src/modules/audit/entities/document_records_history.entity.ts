...
/**
 * Mapea la entidad persistente asociada a `document_records_history`.
 */
@Entity({ schema: 'audit', tableName: 'document_records_history' })
export class DocumentRecordsHistory {
  /**
