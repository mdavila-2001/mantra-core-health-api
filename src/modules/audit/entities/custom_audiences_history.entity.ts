...
/**
 * Mapea la entidad persistente asociada a `custom_audiences_history`.
 */
@Entity({ schema: 'audit', tableName: 'custom_audiences_history' })
export class CustomAudiencesHistory {
  /**
   ...
   */
  @Property({ fieldName: 'custom_audience_id', type: 'uuid' }) // FK → ads.custom_audiences
