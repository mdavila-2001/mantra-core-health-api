...
/**
 * Mapea la entidad persistente asociada a `product_catalogs_history`.
 */
@Entity({ schema: 'audit', tableName: 'product_catalogs_history' })
export class ProductCatalogsHistory {
  /**
  ...
  /**
   * Identificador asociado a product catalogs.
   */
  @Property({ fieldName: 'product_catalogs_id', type: 'uuid' }) // FK → ads.product_catalogs
  productCatalogsId!: string;
