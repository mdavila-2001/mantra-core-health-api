...
/**
 * Mapea la entidad persistente asociada a `wallets_history`.
 */
@Entity({ schema: 'audit', tableName: 'wallets_history' })
export class WalletsHistory {
  ...
  /**
   * Identificador asociado a wallets.
   */
  @Property({ fieldName: 'wallets_id', type: 'uuid' }) // FK → payments.wallets
  walletsId!: string;
