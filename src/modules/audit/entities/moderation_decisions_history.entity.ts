...
/**
 * Mapea la entidad persistente asociada a `moderation_decisions_history`.
 */
@Entity({ schema: 'audit', tableName: 'moderation_decisions_history' })
export class ModerationDecisionsHistory {
  /**
   ...
   */
  @Property({ fieldName: 'moderation_decisions_id', type: 'uuid' }) // FK → community.moderation_decisions
