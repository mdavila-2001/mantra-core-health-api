...
/**
 * Mapea la entidad persistente asociada a `medical_visitors_history`: la revisión
 * punto-en-el-tiempo de cada visitador médico.
 *
 ...
 * quede versionado.
 */
@Entity({ schema: 'audit', tableName: 'medical_visitors_history' })
export class MedicalVisitorsHistory {
  /**
