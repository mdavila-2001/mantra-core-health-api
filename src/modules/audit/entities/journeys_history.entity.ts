...
/**
 * Mapea la entidad persistente asociada a `journeys_history`.
 */
@Entity({ schema: 'audit', tableName: 'journeys_history' })
export class JourneysHistory {
  /**
  ...
  /**
   * Identificador asociado a journeys.
   */
  @Property({ fieldName: 'journeys_id', type: 'uuid' }) // FK → marketing.journeys
  journeysId!: string;
