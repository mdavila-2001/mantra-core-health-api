...
/**
 * Mapea la entidad persistente asociada a `clinical_units_history`.
 */
@Entity({ schema: 'audit', tableName: 'clinical_units_history' })
export class ClinicalUnitsHistory {
  /**
   ...
   */
  @Property({ fieldName: 'clinical_unit_id', type: 'uuid' }) // FK → practice.clinical_units
