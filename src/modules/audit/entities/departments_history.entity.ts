...
/**
 * Mapea la entidad persistente asociada a `departments_history`.
 */
@Entity({ schema: 'audit', tableName: 'departments_history' })
export class DepartmentsHistory {
  /**
   ...
   */
  @Property({ fieldName: 'department_id', type: 'uuid' }) // FK → erp.departments
  departmentId!: string;
