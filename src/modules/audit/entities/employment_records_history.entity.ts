...
/**
 * Mapea la entidad persistente asociada a `employment_records_history`.
 */
@Entity({ schema: 'audit', tableName: 'employment_records_history' })
export class EmploymentRecordsHistory {
  /**
  ...
  /**
   * Identificador asociado a employment record.
   */
