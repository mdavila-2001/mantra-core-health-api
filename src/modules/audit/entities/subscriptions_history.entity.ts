...
/**
 * Mapea la entidad persistente asociada a `subscriptions_history`.
 */
@Entity({ schema: 'audit', tableName: 'subscriptions_history' })
export class SubscriptionsHistory {
  ...
  /**
   * Identificador asociado a subscriptions.
   */
  @Property({ fieldName: 'subscriptions_id', type: 'uuid' }) // FK → payments.subscriptions
