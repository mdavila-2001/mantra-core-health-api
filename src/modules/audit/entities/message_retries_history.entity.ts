...
/**
 * Mapea la entidad persistente asociada a `message_retries_history`.
 */
@Entity({ schema: 'audit', tableName: 'message_retries_history' })
export class MessageRetriesHistory {
  /**
  ...
  /**
   * Identificador asociado a message retry.
   */
  @Property({ fieldName: 'message_retry_id', type: 'uuid' }) // FK → integrations.message_retries
  messageRetryId!: string;
