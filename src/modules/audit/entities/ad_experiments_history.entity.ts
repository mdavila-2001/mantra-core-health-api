...
/**
 * Mapea la entidad persistente asociada a `ad_experiments_history`.
 */
@Entity({ schema: 'audit', tableName: 'ad_experiments_history' })
export class AdExperimentsHistory {
  /**
  ...
  /**
   * Identificador asociado a ad experiments.
   */
  @Property({ fieldName: 'ad_experiments_id', type: 'uuid' }) // FK → ads.ad_experiments
  adExperimentsId!: string;
