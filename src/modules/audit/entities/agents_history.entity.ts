...
/**
 * Mapea la entidad persistente asociada a `agents_history`.
 */
@Entity({ schema: 'audit', tableName: 'agents_history' })
export class AgentsHistory {
  /**
  ...
  /**
   * Identificador asociado a agents.
   */
  @Property({ fieldName: 'agents_id', type: 'uuid' }) // FK → automation.agents
  agentsId!: string;
