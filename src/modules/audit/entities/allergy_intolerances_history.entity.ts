...
/**
 * Mapea la entidad persistente asociada a `allergy_intolerances_history`.
 */
@Entity({ schema: 'audit', tableName: 'allergy_intolerances_history' })
export class AllergyIntolerancesHistory {
  /**
  ...
  /**
   * Identificador asociado a allergy intolerance.
   */
  @Property({ fieldName: 'allergy_intolerance_id', type: 'uuid' }) // FK → clinical.allergy_intolerances
