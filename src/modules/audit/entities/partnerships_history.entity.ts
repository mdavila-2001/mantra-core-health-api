...
/**
 * Mapea la entidad persistente asociada a `partnerships_history`.
 */
@Entity({ schema: 'audit', tableName: 'partnerships_history' })
export class PartnershipsHistory {
  /**
  ...
  /**
   * Identificador asociado a partnerships.
   */
  @Property({ fieldName: 'partnerships_id', type: 'uuid' }) // FK → crm.partnerships
  partnershipsId!: string;
