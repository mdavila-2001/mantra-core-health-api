...
/**
 * Mapea la entidad persistente asociada a `report_schedules_history`.
 */
@Entity({ schema: 'audit', tableName: 'report_schedules_history' })
export class ReportSchedulesHistory {
  /**
