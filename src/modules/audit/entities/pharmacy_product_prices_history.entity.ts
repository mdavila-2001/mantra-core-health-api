...
/**
 * Mapea la entidad persistente asociada a `pharmacy_product_prices_history`.
 */
@Entity({ schema: 'audit', tableName: 'pharmacy_product_prices_history' })
export class PharmacyProductPricesHistory {
  /**
  ...
  /**
   * Identificador asociado a pharmacy product price.
   */
  @Property({ fieldName: 'pharmacy_product_price_id', type: 'uuid' }) // FK → pharmacy.pharmacy_product_prices
  pharmacyProductPriceId!: string;
