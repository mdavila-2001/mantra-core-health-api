...
/**
 * Mapea la entidad persistente asociada a `report_definitions_history`.
 */
@Entity({ schema: 'audit', tableName: 'report_definitions_history' })
export class ReportDefinitionsHistory {
  /**
