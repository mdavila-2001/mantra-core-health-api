...
/**
 * Mapea la entidad persistente asociada a `outbound_messages_history`.
 */
@Entity({ schema: 'audit', tableName: 'outbound_messages_history' })
export class OutboundMessagesHistory {
  /**
