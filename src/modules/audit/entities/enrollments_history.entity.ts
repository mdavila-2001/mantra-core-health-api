...
/**
 * Mapea la entidad persistente asociada a `enrollments_history`.
 */
@Entity({ schema: 'audit', tableName: 'enrollments_history' })
export class EnrollmentsHistory {
  /**
  ...
  /**
   * Identificador asociado a enrollments.
   */
  @Property({ fieldName: 'enrollments_id', type: 'uuid' }) // FK → education.enrollments
