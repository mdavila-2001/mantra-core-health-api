...
/**
 * Mapea la entidad persistente asociada a `visit_requests_history`: la revisión
 * punto-en-el-tiempo de cada solicitud de visita médica.
 *
 ...
 * quede versionado.
 */
@Entity({ schema: 'audit', tableName: 'visit_requests_history' })
export class VisitRequestsHistory {
  /**
