...
/**
 * Mapea la entidad persistente asociada a `dsar_requests`.
 */
@Entity({ schema: 'audit', tableName: 'dsar_requests' })
export class DsarRequests {
  /**
   ...
   */
  @Property({ fieldName: 'result_file_id', type: 'uuid', nullable: true }) // FK → common.files
  resultFileId?: string;
