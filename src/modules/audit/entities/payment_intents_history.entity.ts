...
/**
 * Mapea la entidad persistente asociada a `payment_intents_history`.
 */
@Entity({ schema: 'audit', tableName: 'payment_intents_history' })
export class PaymentIntentsHistory {
  /**
