...
/**
 * Mapea la entidad persistente asociada a `professional_credentials_history`.
 */
@Entity({ schema: 'audit', tableName: 'professional_credentials_history' })
export class ProfessionalCredentialsHistory {
  /**
  ...
  /**
   * Identificador asociado a professional credential.
   */
  @Property({ fieldName: 'professional_credential_id', type: 'uuid' }) // FK → profiles.professional_credentials
  professionalCredentialId!: string;
