...
/**
 * Mapea la entidad persistente asociada a `topics_history`.
 */
@Entity({ schema: 'audit', tableName: 'topics_history' })
export class TopicsHistory {
  /**
  ...
  /**
   * Identificador asociado a topics.
   */
  @Property({ fieldName: 'topics_id', type: 'uuid' }) // FK → community.topics
  topicsId!: string;
