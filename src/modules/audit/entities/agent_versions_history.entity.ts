...
/**
 * Mapea la entidad persistente asociada a `agent_versions_history`.
 */
@Entity({ schema: 'audit', tableName: 'agent_versions_history' })
export class AgentVersionsHistory {
  /**
  ...
  /**
   * Identificador asociado a agent versions.
   */
  @Property({ fieldName: 'agent_versions_id', type: 'uuid' }) // FK → automation.agent_versions
  agentVersionsId!: string;
