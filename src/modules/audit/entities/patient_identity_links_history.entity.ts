...
/**
 * Mapea la entidad persistente asociada a `patient_identity_links_history`.
 */
@Entity({ schema: 'audit', tableName: 'patient_identity_links_history' })
export class PatientIdentityLinksHistory {
  /**
  ...
  /**
   * Identificador asociado a patient identity link.
   */
  @Property({ fieldName: 'patient_identity_link_id', type: 'uuid' }) // FK → profiles.patient_identity_links
  patientIdentityLinkId!: string;
