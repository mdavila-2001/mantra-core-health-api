...
/**
 * Mapea la entidad persistente asociada a `message_templates_history`.
 */
@Entity({ schema: 'audit', tableName: 'message_templates_history' })
export class MessageTemplatesHistory {
  /**
  ...
  /**
   * Identificador asociado a message template.
   */
  @Property({ fieldName: 'message_template_id', type: 'uuid' }) // FK → messaging.message_templates
