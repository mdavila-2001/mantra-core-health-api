...
/**
 * Mapea la entidad persistente asociada a `schedule_templates_history`.
 */
@Entity({ schema: 'audit', tableName: 'schedule_templates_history' })
export class ScheduleTemplatesHistory {
  /**
