...
/**
 * Mapea la entidad persistente asociada a `referral_programs_history`.
 */
@Entity({ schema: 'audit', tableName: 'referral_programs_history' })
export class ReferralProgramsHistory {
  /**
  ...
  /**
   * Identificador asociado a referral programs.
   */
  @Property({ fieldName: 'referral_programs_id', type: 'uuid' }) // FK → promotions.referral_programs
  referralProgramsId!: string;
