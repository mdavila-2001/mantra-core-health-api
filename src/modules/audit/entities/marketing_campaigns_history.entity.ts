...
/**
 * Mapea la entidad persistente asociada a `marketing_campaigns_history`.
 */
@Entity({ schema: 'audit', tableName: 'marketing_campaigns_history' })
export class MarketingCampaignsHistory {
  /**
  ...
  /**
   * Identificador asociado a marketing campaigns.
   */
  @Property({ fieldName: 'marketing_campaigns_id', type: 'uuid' }) // FK → marketing.marketing_campaigns
  marketingCampaignsId!: string;
