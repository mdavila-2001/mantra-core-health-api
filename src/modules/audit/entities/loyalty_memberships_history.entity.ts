...
/**
 * Mapea la entidad persistente asociada a `loyalty_memberships_history`.
 */
@Entity({ schema: 'audit', tableName: 'loyalty_memberships_history' })
export class LoyaltyMembershipsHistory {
  /**
  ...
  /**
   * Identificador asociado a loyalty memberships.
   */
  @Property({ fieldName: 'loyalty_memberships_id', type: 'uuid' }) // FK → promotions.loyalty_memberships
  loyaltyMembershipsId!: string;
