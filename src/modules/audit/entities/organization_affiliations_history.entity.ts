...
/**
 * Mapea la entidad persistente asociada a `organization_affiliations_history`.
 */
@Entity({ schema: 'audit', tableName: 'organization_affiliations_history' })
export class OrganizationAffiliationsHistory {
  /**
  ...
  /**
   * Identificador asociado a organization affiliation.
   */
  @Property({ fieldName: 'organization_affiliation_id', type: 'uuid' }) // FK → organization_extensions.organization_affiliations
  organizationAffiliationId!: string;
