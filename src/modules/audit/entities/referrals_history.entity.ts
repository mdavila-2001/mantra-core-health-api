...
/**
 * Mapea la entidad persistente asociada a `referrals_history`.
 */
@Entity({ schema: 'audit', tableName: 'referrals_history' })
export class ReferralsHistory {
  /**
   ...
   */
  @Property({ fieldName: 'referral_id', type: 'uuid' }) // FK → clinical_ext.referrals
  referralId!: string;
