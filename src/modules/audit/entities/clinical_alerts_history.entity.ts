...
/**
 * Mapea la entidad persistente asociada a `clinical_alerts_history`.
 */
@Entity({ schema: 'audit', tableName: 'clinical_alerts_history' })
export class ClinicalAlertsHistory {
  /**
  ...
  /**
   * Identificador asociado a clinical alert.
   */
  @Property({ fieldName: 'clinical_alert_id', type: 'uuid' }) // FK → clinical_ext.clinical_alerts
  clinicalAlertId!: string;
