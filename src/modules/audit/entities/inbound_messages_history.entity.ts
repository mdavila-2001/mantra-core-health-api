...
/**
 * Mapea la entidad persistente asociada a `inbound_messages_history`.
 */
@Entity({ schema: 'audit', tableName: 'inbound_messages_history' })
export class InboundMessagesHistory {
  /**
   ...
   */
  @Property({ fieldName: 'inbound_message_id', type: 'uuid' }) // FK → integrations.inbound_messages
