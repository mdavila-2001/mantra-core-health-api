...
/**
 * Mapea la entidad persistente asociada a `regulatory_documents_history`: la revisión
 * punto-en-el-tiempo de cada documento regulatorio.
 *
 ...
 * quede versionado.
 */
@Entity({ schema: 'audit', tableName: 'regulatory_documents_history' })
export class RegulatoryDocumentsHistory {
  /**
