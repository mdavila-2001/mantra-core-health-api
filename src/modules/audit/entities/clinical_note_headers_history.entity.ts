...
/**
 * Mapea la entidad persistente asociada a `clinical_note_headers_history`.
 */
@Entity({ schema: 'audit', tableName: 'clinical_note_headers_history' })
export class ClinicalNoteHeadersHistory {
  /**
  ...
  /**
   * Identificador asociado a clinical note header.
   */
  @Property({ fieldName: 'clinical_note_header_id', type: 'uuid' }) // FK → chart.clinical_note_headers
  clinicalNoteHeaderId!: string;
