...
/**
 * Mapea la entidad persistente asociada a `appointment_bookings_history`.
 */
@Entity({ schema: 'audit', tableName: 'appointment_bookings_history' })
export class AppointmentBookingsHistory {
  /**
