...
/**
 * Mapea la entidad persistente asociada a `provider_channel_configs_history`.
 */
@Entity({ schema: 'audit', tableName: 'provider_channel_configs_history' })
export class ProviderChannelConfigsHistory {
  /**
