...
/**
 * Mapea la entidad persistente asociada a `cds_rules_history`.
 */
@Entity({ schema: 'audit', tableName: 'cds_rules_history' })
export class CdsRulesHistory {
  /**
  ...
  /**
   * Identificador asociado a cds rule.
   */
  @Property({ fieldName: 'cds_rule_id', type: 'uuid' }) // FK → clinical_ext.cds_rules
  cdsRuleId!: string;
