...
/**
 * Mapea la entidad persistente asociada a `workflows_history`.
 */
@Entity({ schema: 'audit', tableName: 'workflows_history' })
export class WorkflowsHistory {
  /**
  ...
  /**
   * Identificador asociado a workflows.
   */
  @Property({ fieldName: 'workflows_id', type: 'uuid' }) // FK → automation.workflows
  workflowsId!: string;
