...
/**
 * Mapea la entidad persistente asociada a `trackable_subjects_history`.
 */
@Entity({ schema: 'audit', tableName: 'trackable_subjects_history' })
export class TrackableSubjectsHistory {
  /**
