...
/**
 * Mapea la entidad persistente asociada a `payment_methods_history`.
 */
@Entity({ schema: 'audit', tableName: 'payment_methods_history' })
export class PaymentMethodsHistory {
  /**
   ...
   */
  @Property({ fieldName: 'payment_method_id', type: 'uuid' }) // FK → payments.payment_methods
