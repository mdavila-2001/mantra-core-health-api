...
/**
 * Mapea la entidad persistente asociada a `automated_rules_history`.
 */
@Entity({ schema: 'audit', tableName: 'automated_rules_history' })
export class AutomatedRulesHistory {
  /**
  ...
  /**
   * Identificador asociado a automated rules.
   */
  @Property({ fieldName: 'automated_rules_id', type: 'uuid' }) // FK → ads.automated_rules
  automatedRulesId!: string;
