...
/**
 * Mapea la entidad persistente asociada a `guardrail_policies_history`.
 */
@Entity({ schema: 'audit', tableName: 'guardrail_policies_history' })
export class GuardrailPoliciesHistory {
  /**
  ...
  /**
   * Identificador asociado a guardrail policies.
   */
  @Property({ fieldName: 'guardrail_policies_id', type: 'uuid' }) // FK → automation.guardrail_policies
  guardrailPoliciesId!: string;
