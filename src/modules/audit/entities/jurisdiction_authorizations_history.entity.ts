...
/**
 * Mapea la entidad persistente asociada a `jurisdiction_authorizations_history`.
 */
@Entity({ schema: 'audit', tableName: 'jurisdiction_authorizations_history' })
export class JurisdictionAuthorizationsHistory {
  /**
  ...
  /**
   * Identificador asociado a jurisdiction authorization.
   */
  @Property({ fieldName: 'jurisdiction_authorization_id', type: 'uuid' }) // FK → profiles.jurisdiction_authorizations
