...
/**
 * Mapea la entidad persistente asociada a `custom_conversions_history`.
 */
@Entity({ schema: 'audit', tableName: 'custom_conversions_history' })
export class CustomConversionsHistory {
  /**
  ...
  /**
   * Identificador asociado a custom conversions.
   */
  @Property({ fieldName: 'custom_conversions_id', type: 'uuid' }) // FK → ads.custom_conversions
  customConversionsId!: string;
