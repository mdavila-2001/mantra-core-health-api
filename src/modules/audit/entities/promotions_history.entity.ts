...
/**
 * Mapea la entidad persistente asociada a `promotions_history`.
 */
@Entity({ schema: 'audit', tableName: 'promotions_history' })
export class PromotionsHistory {
  /**
  ...
  /**
   * Identificador asociado a promotions.
   */
  @Property({ fieldName: 'promotions_id', type: 'uuid' }) // FK → promotions.promotions
  promotionsId!: string;
