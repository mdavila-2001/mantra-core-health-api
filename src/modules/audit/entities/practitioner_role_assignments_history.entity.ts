...
/**
 * Mapea la entidad persistente asociada a `practitioner_role_assignments_history`.
 */
@Entity({ schema: 'audit', tableName: 'practitioner_role_assignments_history' })
export class PractitionerRoleAssignmentsHistory {
  /**
