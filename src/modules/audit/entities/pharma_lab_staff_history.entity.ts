...
/**
 * Mapea la entidad persistente asociada a `pharma_lab_staff_history`: la revisión
 * punto-en-el-tiempo de cada ficha de personal del laboratorio.
 *
 ...
 * quede versionado.
 */
@Entity({ schema: 'audit', tableName: 'pharma_lab_staff_history' })
export class PharmaLabStaffHistory {
  /**
   ...
   */
  @Property({ fieldName: 'pharma_lab_staff_id', type: 'uuid' }) // FK → pharma_lab.pharma_lab_staff
  pharmaLabStaffId!: string;
