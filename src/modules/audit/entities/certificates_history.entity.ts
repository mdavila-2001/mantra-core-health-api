...
/**
 * Mapea la entidad persistente asociada a `certificates_history`.
 */
@Entity({ schema: 'audit', tableName: 'certificates_history' })
export class CertificatesHistory {
  /**
  ...
  /**
   * Identificador asociado a certificates.
   */
  @Property({ fieldName: 'certificates_id', type: 'uuid' }) // FK → education.certificates
