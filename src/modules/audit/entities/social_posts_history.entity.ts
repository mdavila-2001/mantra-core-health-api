...
/**
 * Mapea la entidad persistente asociada a `social_posts_history`.
 */
@Entity({ schema: 'audit', tableName: 'social_posts_history' })
export class SocialPostsHistory {
  /**
  ...
  /**
   * Identificador asociado a social post.
   */
  @Property({ fieldName: 'social_post_id', type: 'uuid' }) // FK → community.social_posts
  socialPostId!: string;
