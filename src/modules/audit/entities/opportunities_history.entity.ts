...
/**
 * Mapea la entidad persistente asociada a `opportunities_history`.
 */
@Entity({ schema: 'audit', tableName: 'opportunities_history' })
export class OpportunitiesHistory {
  /**
  ...
  /**
   * Identificador asociado a opportunities.
   */
  @Property({ fieldName: 'opportunities_id', type: 'uuid' }) // FK → crm.opportunities
