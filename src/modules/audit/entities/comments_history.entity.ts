...
/**
 * Mapea la entidad persistente asociada a `comments_history`.
 */
@Entity({ schema: 'audit', tableName: 'comments_history' })
export class CommentsHistory {
  ...
  /**
   * Identificador asociado a comments.
   */
  @Property({ fieldName: 'comments_id', type: 'uuid' }) // FK → community.comments
  commentsId!: string;
