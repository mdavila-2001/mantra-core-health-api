...
/**
 * Mapea la entidad persistente asociada a `product_sets_history`.
 */
@Entity({ schema: 'audit', tableName: 'product_sets_history' })
export class ProductSetsHistory {
  /**
  ...
  /**
   * Identificador asociado a product sets.
   */
  @Property({ fieldName: 'product_sets_id', type: 'uuid' }) // FK → ads.product_sets
