...
/**
 * Mapea la entidad persistente asociada a `integration_endpoints_history`.
 */
@Entity({ schema: 'audit', tableName: 'integration_endpoints_history' })
export class IntegrationEndpointsHistory {
  /**
