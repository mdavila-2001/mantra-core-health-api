...
/**
 * Mapea la entidad persistente asociada a `course_versions_history`.
 */
@Entity({ schema: 'audit', tableName: 'course_versions_history' })
export class CourseVersionsHistory {
  /**
  ...
  /**
   * Identificador asociado a course versions.
   */
  @Property({ fieldName: 'course_versions_id', type: 'uuid' }) // FK → education.course_versions
  courseVersionsId!: string;
