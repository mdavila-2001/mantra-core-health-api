...
/**
 * Mapea la entidad persistente asociada a `conversations_history`.
 */
@Entity({ schema: 'audit', tableName: 'conversations_history' })
export class ConversationsHistory {
  /**
  ...
  /**
   * Identificador asociado a conversations.
   */
  @Property({ fieldName: 'conversations_id', type: 'uuid' }) // FK → community.conversations
