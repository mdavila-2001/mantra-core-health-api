...
/**
 * Mapea la entidad persistente asociada a `payment_mandates_history`.
 */
@Entity({ schema: 'audit', tableName: 'payment_mandates_history' })
export class PaymentMandatesHistory {
  /**
  ...
  /**
   * Identificador asociado a payment mandates.
   */
  @Property({ fieldName: 'payment_mandates_id', type: 'uuid' }) // FK → payments.payment_mandates
  paymentMandatesId!: string;
