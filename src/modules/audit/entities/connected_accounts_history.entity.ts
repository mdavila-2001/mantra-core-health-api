...
/**
 * Mapea la entidad persistente asociada a `connected_accounts_history`.
 */
@Entity({ schema: 'audit', tableName: 'connected_accounts_history' })
export class ConnectedAccountsHistory {
  /**
  ...
  /**
   * Identificador asociado a connected accounts.
   */
  @Property({ fieldName: 'connected_accounts_id', type: 'uuid' }) // FK → payments.connected_accounts
