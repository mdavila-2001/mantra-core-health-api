...
/**
 * Mapea la entidad persistente asociada a `medication_requests_history`.
 */
@Entity({ schema: 'audit', tableName: 'medication_requests_history' })
export class MedicationRequestsHistory {
  /**
