...
/**
 * Mapea la entidad persistente asociada a `contacts_history`.
 */
@Entity({ schema: 'audit', tableName: 'contacts_history' })
export class ContactsHistory {
  /**
  ...
  /**
   * Identificador asociado a contacts.
   */
  @Property({ fieldName: 'contacts_id', type: 'uuid' }) // FK → crm.contacts
  contactsId!: string;
