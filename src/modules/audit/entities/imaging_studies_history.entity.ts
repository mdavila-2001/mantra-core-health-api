...
/**
 * Mapea la entidad persistente asociada a `imaging_studies_history`.
 */
@Entity({ schema: 'audit', tableName: 'imaging_studies_history' })
export class ImagingStudiesHistory {
  /**
