...
/**
 * Mapea la entidad persistente asociada a `federated_identities_history`.
 */
@Entity({ schema: 'audit', tableName: 'federated_identities_history' })
export class FederatedIdentitiesHistory {
  /**
   ...
   */
  @Property({ fieldName: 'federated_identity_id', type: 'uuid' }) // FK → auth_providers.federated_identities
