...
/**
 * Mapea la entidad persistente asociada a `verified_badges_history`.
 */
@Entity({ schema: 'audit', tableName: 'verified_badges_history' })
export class VerifiedBadgesHistory {
  /**
  ...
  /**
   * Identificador asociado a verified badges.
   */
  @Property({ fieldName: 'verified_badges_id', type: 'uuid' }) // FK → community.verified_badges
  verifiedBadgesId!: string;
