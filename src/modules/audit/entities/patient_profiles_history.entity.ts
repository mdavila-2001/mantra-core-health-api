...
/**
 * Mapea la entidad persistente asociada a `patient_profiles_history`.
 */
@Entity({ schema: 'audit', tableName: 'patient_profiles_history' })
export class PatientProfilesHistory {
  /**
