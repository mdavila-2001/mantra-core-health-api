...
/**
 * Mapea la entidad persistente asociada a `diagnostic_reports_history`.
 */
@Entity({ schema: 'audit', tableName: 'diagnostic_reports_history' })
export class DiagnosticReportsHistory {
  /**
