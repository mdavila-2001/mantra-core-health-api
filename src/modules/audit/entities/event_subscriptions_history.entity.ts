...
/**
 * Mapea la entidad persistente asociada a `event_subscriptions_history`.
 */
@Entity({ schema: 'audit', tableName: 'event_subscriptions_history' })
export class EventSubscriptionsHistory {
  /**
  ...
  /**
   * Identificador asociado a event subscription.
   */
  @Property({ fieldName: 'event_subscription_id', type: 'uuid' }) // FK → messaging.event_subscriptions
