...
/**
 * Mapea la entidad persistente asociada a `identity_providers_history`.
 */
@Entity({ schema: 'audit', tableName: 'identity_providers_history' })
export class IdentityProvidersHistory {
  /**
  ...
  /**
   * Identificador asociado a identity provider.
   */
  @Property({ fieldName: 'identity_provider_id', type: 'uuid' }) // FK → auth_providers.identity_providers
