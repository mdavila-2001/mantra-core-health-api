...
/**
 * Mapea la entidad persistente asociada a `journal_transactions_history`.
 */
@Entity({ schema: 'audit', tableName: 'journal_transactions_history' })
export class JournalTransactionsHistory {
  /**
