...
/**
 * Mapea la entidad persistente asociada a `subscription_plans_history`.
 */
@Entity({ schema: 'audit', tableName: 'subscription_plans_history' })
export class SubscriptionPlansHistory {
  /**
  ...
  /**
   * Identificador asociado a subscription plans.
   */
  @Property({ fieldName: 'subscription_plans_id', type: 'uuid' }) // FK → payments.subscription_plans
