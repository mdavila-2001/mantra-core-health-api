...
/**
 * Mapea la entidad persistente asociada a `payment_transactions_history`.
 */
@Entity({ schema: 'audit', tableName: 'payment_transactions_history' })
export class PaymentTransactionsHistory {
  /**
