...
/**
 * Mapea la entidad persistente asociada a `pharma_labs_history`: la revisión
 * punto-en-el-tiempo de cada laboratorio farmacéutico.
 *
 ...
 * quede versionado.
 */
@Entity({ schema: 'audit', tableName: 'pharma_labs_history' })
export class PharmaLabsHistory {
  /**
