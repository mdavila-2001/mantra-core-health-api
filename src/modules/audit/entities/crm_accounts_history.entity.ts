...
/**
 * Mapea la entidad persistente asociada a `crm_accounts_history`.
 */
@Entity({ schema: 'audit', tableName: 'crm_accounts_history' })
export class CrmAccountsHistory {
  /**
  ...
  /**
   * Identificador asociado a crm accounts.
   */
  @Property({ fieldName: 'crm_accounts_id', type: 'uuid' }) // FK → crm.crm_accounts
  crmAccountsId!: string;
