...
/**
 * Mapea la entidad persistente asociada a `test_suites_history`.
 */
@Entity({ schema: 'audit', tableName: 'test_suites_history' })
export class TestSuitesHistory {
  /**
  ...
  /**
   * Identificador asociado a test suite.
   */
  @Property({ fieldName: 'test_suite_id', type: 'uuid' }) // FK → qa_lab.test_suites
  testSuiteId!: string;
