...
/**
 * Mapea la entidad persistente asociada a `public_profiles_history`.
 */
@Entity({ schema: 'audit', tableName: 'public_profiles_history' })
export class PublicProfilesHistory {
  /**
