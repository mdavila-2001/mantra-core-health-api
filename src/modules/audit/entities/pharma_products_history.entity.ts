...
/**
 * Mapea la entidad persistente asociada a `pharma_products_history`: la revisión
 * punto-en-el-tiempo de cada medicamento del catálogo.
 *
 ...
 * quede versionado.
 */
@Entity({ schema: 'audit', tableName: 'pharma_products_history' })
export class PharmaProductsHistory {
  /**
