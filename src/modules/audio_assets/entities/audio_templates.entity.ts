...
export class AudioTemplates {
  ...
  @Property({ fieldName: 'text_template', columnType: 'text' }) textTemplate!: string;
  @Property({ fieldName: 'fallback_text', columnType: 'text', nullable: true }) fallbackText?: string;
  @Property({ fieldName: 'dynamic_fields_json', type: 'json', columnType: 'jsonb' }) dynamicFieldsJson!: unknown;
