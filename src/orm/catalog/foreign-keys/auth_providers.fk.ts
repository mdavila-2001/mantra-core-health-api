...
export const authProvidersForeignKeys: readonly ForeignKeyTuple[] = [
  ...
  ['account_link_requests', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['federated_identities', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['federated_login_attempts', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['provider_attribute_mappings', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['provider_protocol_configs', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['provider_signing_keys', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['provider_tenant_bindings', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
  ...
  ['provisioning_rules', 'provider_id', 'auth_providers', 'identity_providers', 'id'],
