# database / SQL / 27 identity assurance

Agrupa los componentes relacionados con **27 identity assurance** y mantiene cohesionada esta responsabilidad del sistema.
