# database / SQL / 22 organization extensions

Agrupa los componentes relacionados con **22 organization extensions** y mantiene cohesionada esta responsabilidad del sistema.
