...
DO $$ BEGIN
    ALTER TABLE "health_data"."canonical_health_resource_versions"
        ADD CONSTRAINT "fk_canonical_health_resource_versions_canonical_health_resource_id" FOREIGN KEY ("canonical_health_resource_id")
        REFERENCES "health_data"."canonical_health_resources" ("id");
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
    ALTER TABLE "health_data"."canonical_health_resource_versions"
        ADD CONSTRAINT "fk_canonical_health_resource_versions_health_ingestion_record_id" FOREIGN KEY ("health_ingestion_record_id")
...
DO $$ BEGIN
    ALTER TABLE "health_data"."health_terminology_mapping_rules"
        ADD CONSTRAINT "fk_health_terminology_mapping_rules_health_terminology_mapping_set_id" FOREIGN KEY ("health_terminology_mapping_set_id")
        REFERENCES "health_data"."health_terminology_mapping_sets" ("id");
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
    ALTER TABLE "health_data"."health_deidentification_runs"
        ADD CONSTRAINT "fk_health_deidentification_runs_health_deidentification_profile_id" FOREIGN KEY ("health_deidentification_profile_id")
