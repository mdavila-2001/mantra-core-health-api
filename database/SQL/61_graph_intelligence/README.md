# database / SQL / 61 graph intelligence

Agrupa los componentes relacionados con **61 graph intelligence** y mantiene cohesionada esta responsabilidad del sistema.
