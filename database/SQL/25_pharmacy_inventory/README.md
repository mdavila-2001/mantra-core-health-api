# database / SQL / 25 pharmacy inventory

Agrupa los componentes relacionados con **25 pharmacy inventory** y mantiene cohesionada esta responsabilidad del sistema.
