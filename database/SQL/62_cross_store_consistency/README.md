# database / SQL / 62 cross store consistency

Agrupa los componentes relacionados con **62 cross store consistency** y mantiene cohesionada esta responsabilidad del sistema.
