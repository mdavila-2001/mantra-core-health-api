# database / SQL / 31 integration contracts

Agrupa los componentes relacionados con **31 integration contracts** y mantiene cohesionada esta responsabilidad del sistema.
