...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_diagnostic_units_tenant_id" ON "diagnostic_units"."diagnostic_units" ("tenant_id");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_diagnostic_units_code" ON "diagnostic_units"."diagnostic_units" ("code");
