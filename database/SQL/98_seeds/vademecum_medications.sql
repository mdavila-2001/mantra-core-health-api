-- =============================================================================
-- SEED: VADEMÉCUM (catálogo de referencia de medicamentos)
-- =============================================================================
-- Catálogo de medicamentos de referencia modelado como conceptos de
-- terminología (terminology.catalog_concepts), basado en el índice ATC de la
-- OMS y enriquecido con RxNorm / SNOMED CT, designaciones EN/ES + marcas,
-- propiedades clínicas (jsonb) e interacciones farmacológicas.
--
