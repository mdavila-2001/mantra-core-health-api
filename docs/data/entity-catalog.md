...
> **1184 entidades MikroORM reales** (`tools/catalog/lib/tsentities.mjs`) contra el
...
> `yarn orm:catalog`). **1179/1184** entidades tienen descripción de negocio
> verificada en la bóveda; las que no, se marcan explícitamente en vez de fabricar una frase
> genérica.
>
> Este es el catálogo de lo **implementado**. La bóveda describe 1324 entidades en total
...
## Por schema (57 schemas · 1184 entidades)
...
| `care_relationships` | `CareRelationships` | 15 | `id` | ✅ | _sin descripción verificada en la bóveda_ |
...
| `patient_legal_representations` | `PatientLegalRepresentations` | 14 | `id` | ✅ | _sin descripción verificada en la bóveda_ |
...
| `prescription_signature_policies` | `PrescriptionSignaturePolicies` | 13 | `id` | ✅ | _sin descripción verificada en la bóveda_ |
...
### `iam` (12 entidades, módulo `iam`)

| Tabla | Clase | Campos | PK | Bloqueo optimista | Propósito de negocio |
|---|---|---:|---|:---:|---|
| `account_activations` | `AccountActivations` | 14 | `id` | ✅ | _sin descripción verificada en la bóveda_ |
...
| `persons` | `Persons` | 18 | `id` | ✅ | persons es un registro central de negocio del módulo 05 · profiles (personas, pacientes y fuerza laboral de salud), dominio Núcleo y Terminología. |
...
| `booking_confirmation_rules` | `BookingConfirmationRules` | 16 | `id` | ✅ | _sin descripción verificada en la bóveda_ |
