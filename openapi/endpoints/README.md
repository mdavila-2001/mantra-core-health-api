...
| [chart](chart.md) | 14 | `chart-care-plans`, `chart-documents`, `chart-notes`, `chart-templates`, `charts-read` | 5 |
| [clinical](clinical.md) | 24 | `clinical-encounters`, `clinical-observations`, `clinical-orders`, `clinical-prescription-policies`, `clinical-records`, `clinical-summary` | 6 |
...
| [profiles](profiles.md) | 15 | `profiles-patients`, `profiles-patients-read`, `profiles-practitioners` | 3 |
...
| [scheduling](scheduling.md) | 25 | `scheduling`, `scheduling-agenda`, `scheduling-bookings`, `scheduling-confirmation`, `scheduling-internal` | 5 |
