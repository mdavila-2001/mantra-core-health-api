...
Esta referencia documenta **907 de 907 operaciones HTTP** registradas en `openapi/openapi.json`, agrupadas en **61 módulos**. Cada endpoint incluye módulo, nombre, descripciones de negocio y sistema, parámetros, payload mínimo, restricciones, payload completo, respuesta exitosa y errores posibles.
...
La generación falla si la cantidad documentada difiere de las 907 operaciones encontradas. Los archivos de esta carpeta son derivados; los cambios permanentes deben hacerse en decoradores, DTOs, controladores, servicios o en el generador.
