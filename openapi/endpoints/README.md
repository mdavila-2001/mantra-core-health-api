...
Esta referencia documenta **915 de 915 operaciones HTTP** registradas en `openapi/openapi.json`, agrupadas en **62 módulos**. Cada endpoint incluye módulo, nombre, descripciones de negocio y sistema, parámetros, payload mínimo, restricciones, payload completo, respuesta exitosa y errores posibles.
...
| [ads](ads.md) | 18 | `ads` | 1 |
| [app](app.md) | 6 | `app` | 2 |
| [audio_tts](audio-tts.md) | 8 | `audio-tts`, `audio-tts-internal` | 2 |
...
La generación falla si la cantidad documentada difiere de las 915 operaciones encontradas. Los archivos de esta carpeta son derivados; los cambios permanentes deben hacerse en decoradores, DTOs, controladores, servicios o en el generador.
