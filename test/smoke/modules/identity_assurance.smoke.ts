...
export const IDENTITY_ASSURANCE_SMOKE: SmokeCase[] = [
  // ---- UC-27-01: registrar autoridad ---------------------------------------
  {
    ...
    endpoint: 'POST /identity/authorities',
    name: 'happy: registrar autoridad',
    method: 'post',
    path: () => '/identity/authorities',
    body: (c) => ({
      tenantId: c.tenantId,
      authorityCode: `IDA-A-${c.u}`,
      name: 'Registro Nacional',
      authorityTypeConceptId: CID,
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaAuthorityId = String(b.id);
    },
  },
  {
    module: 'IdentityAssurance',
  ...
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/authorities',
    name: 'límite: validación (falta authorityTypeConceptId)',
    method: 'post',
    path: () => '/identity/authorities',
    body: (c) => ({
      tenantId: c.tenantId,
      authorityCode: `IDA-A-y-${c.u}`,
      name: 'X',
    }),
    expectedStatus: 400,
  },
  ...
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/authorities/{id}/endpoints',
    name: 'happy: publicar endpoint',
    method: 'post',
    path: (c) => `/identity/authorities/${c.vars.idaAuthorityId}/endpoints`,
    body: (c) => ({
      integrationEndpointId: c.vars.integEndpointId,
      capabilityConceptId: CID,
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaEndpointId = String(b.id);
    },
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/authorities/{id}/endpoints',
    name: 'límite: autoridad inexistente',
    method: 'post',
    path: () => `/identity/authorities/${UUID_ABSENT}/endpoints`,
    body: (c) => ({
      integrationEndpointId: c.vars.integEndpointId,
      capabilityConceptId: CID,
    }),
  ...
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/verification-policies',
    name: 'happy: crear política',
    method: 'post',
    path: () => '/identity/verification-policies',
    body: (c) => ({
      policyCode: `IDA-P-${c.u}`,
      subjectTypeConceptId: CID,
      transactionRiskConceptId: CID,
      requiredIdentityAssuranceLevelConceptId: CID,
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaPolicyId = String(b.id);
    },
  },
  {
    module: 'IdentityAssurance',
  ...
  // ---- UC-27-02: abrir caso de verificación --------------------------------
  {
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaCaseId = String(b.id);
    },
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/verification-cases',
    name: 'límite: política inexistente',
    method: 'post',
    path: () => '/identity/verification-cases',
    body: (c) => ({
      identityVerificationPolicyId: UUID_ABSENT,
      subjectTypeConceptId: CID,
      subjectEntityId: c.adminUserId,
    }),
    expectedStatus: 404,
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/verification-cases',
    name: 'límite: validación (falta política)',
    method: 'post',
    path: () => '/identity/verification-cases',
    body: (c) => ({
      subjectTypeConceptId: CID,
  ...
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/verification-cases/{id}/evidence',
    name: 'happy: aportar evidencia',
    method: 'post',
    path: (c) => `/identity/verification-cases/${c.vars.idaCaseId}/evidence`,
    body: () => ({
      evidenceTypeConceptId: CID,
      evidenceIdentifierHash: 'sha256:deadbeef',
    }),
    expectedStatus: 201,
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/verification-cases/{id}/evidence',
    name: 'límite: caso inexistente',
    method: 'post',
    path: () => `/identity/verification-cases/${UUID_ABSENT}/evidence`,
  ...
  // ---- UC-27-04: planificar checks -----------------------------------------
  {
    ...
    name: 'happy: planificar checks',
    method: 'post',
    path: (c) => `/identity/verification-cases/${c.vars.idaCaseId}/checks:plan`,
    body: () => ({ checks: [{ checkTypeConceptId: CID, required: true }] }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaCheckId = String((b.checkIds as string[])[0]);
    },
  },
  {
    module: 'IdentityAssurance',
  ...
  // ---- UC-27-05: registrar intento -----------------------------------------
  {
    ...
    name: 'happy: registrar intento',
    method: 'post',
    path: (c) => `/identity/checks/${c.vars.idaCheckId}/attempts`,
    body: (c) => ({
  ...
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/checks/{id}/attempts',
    name: 'límite: check inexistente',
    method: 'post',
    path: (c) => `/identity/checks/${UUID_ABSENT}/attempts`,
  ...
  // ---- UC-27-06: registrar resultado ---------------------------------------
  {
    ...
    name: 'happy: registrar resultado',
    method: 'post',
    path: (c) => `/identity/checks/${c.vars.idaCheckId}/results`,
  ...
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/checks/{id}/results',
    name: 'límite: validación (result inválido)',
    method: 'post',
    path: (c) => `/identity/checks/${c.vars.idaCheckId}/results`,
    body: () => ({ result: 'MAYBE' }),
    expectedStatus: 400,
  ...
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/verification-cases/{id}/fraud-signals',
    name: 'happy: registrar señal de fraude',
    method: 'post',
    path: (c) =>
      `/identity/verification-cases/${c.vars.idaCaseId}/fraud-signals`,
    body: () => ({
      signalTypeConceptId: CID,
  ...
  },
  {
    ...
    name: 'límite: caso inexistente',
    method: 'post',
    path: () => `/identity/verification-cases/${UUID_ABSENT}/fraud-signals`,
  ...
  },
  {
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaReviewId = String(b.id);
    },
  },
  {
    module: 'IdentityAssurance',
  ...
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/manual-review/{id}/decision',
    name: 'happy: aprobar revisión',
    method: 'post',
    path: (c) => `/identity/manual-review/${c.vars.idaReviewId}/decision`,
    body: () => ({
      decision: 'APPROVED',
      decisionReason: 'Evidencia verificada',
    }),
    expectedStatus: 200,
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/manual-review/{id}/decision',
    name: 'límite: revisión inexistente',
    method: 'post',
    path: () => `/identity/manual-review/${UUID_ABSENT}/decision`,
  ...
  // ---- UC-27-10: emitir aserción -------------------------------------------
  {
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.idaAssertionId = String(b.id);
    },
  },
  {
    module: 'IdentityAssurance',
  ...
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/assertions/{id}/revoke',
    name: 'happy: revocar aserción',
    method: 'post',
    path: (c) => `/identity/assertions/${c.vars.idaAssertionId}/revoke`,
    body: () => ({}),
    expectedStatus: 200,
  },
  {
    module: 'IdentityAssurance',
    endpoint: 'POST /identity/assertions/{id}/revoke',
    name: 'límite: doble revocación (conflicto)',
    method: 'post',
    path: (c) => `/identity/assertions/${c.vars.idaAssertionId}/revoke`,
    body: () => ({}),
    expectedStatus: 409,
