...
export const DIAGNOSTICS_SMOKE: SmokeCase[] = [
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/specimens',
    name: 'happy: alta de espécimen',
    method: 'post',
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagSpecimenId = String(b.id);
    },
  },
  {
    module: 'Diagnostics',
  ...
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/specimens',
    name: 'límite: validación (falta specimenTypeConceptId)',
    method: 'post',
    path: () => '/diagnostics/specimens',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
  ...
  // ---- Segundo espécimen para el flujo de rechazo (UC-02) --------------------
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/specimens',
    name: 'happy: espécimen para rechazo',
    method: 'post',
    path: () => '/diagnostics/specimens',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagRejectSpecimenId = String(b.id);
    },
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/accessions',
    name: 'happy: acesionar espécimen',
    method: 'post',
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagAccessionId = String(b.id);
    },
  },
  {
    module: 'Diagnostics',
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/specimens/{id}/rejection',
    name: 'happy: rechazar espécimen',
    method: 'post',
    path: (c) =>
      `/diagnostics/specimens/${c.vars.diagRejectSpecimenId}/rejection`,
  ...
  },
  {
    ...
    name: 'límite: espécimen inexistente',
    method: 'post',
    path: () => `/diagnostics/specimens/${UUID_ABSENT}/rejection`,
    body: () => ({ rejectionReasonConceptId: CID }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/specimens/{id}/containers',
    name: 'happy: alta de contenedor',
    method: 'post',
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagContainerId = String(b.id);
    },
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/containers/{id}/custody-events',
    name: 'happy: custodia/traslado',
    method: 'post',
    path: (c) =>
      `/diagnostics/containers/${c.vars.diagContainerId}/custody-events`,
    body: (c) => ({
      specimenId: c.vars.diagSpecimenId,
      temperatureCelsius: '4.0',
      sealIdentifier: 'SEAL-1',
    }),
    expectedStatus: 201,
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/containers/{id}/custody-events',
    name: 'límite: contenedor inexistente',
    method: 'post',
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/work-orders',
    name: 'happy: abrir orden y desglosar pruebas',
    method: 'post',
    ...
    capture: (b, c) => {
      ...
      if (Array.isArray(b.testIds) && b.testIds.length)
        c.vars.diagWorkOrderTestId = String(b.testIds[0]);
    },
  },
  {
    module: 'Diagnostics',
    ...
    name: 'límite: acesión inexistente',
    method: 'post',
    path: (c) => '/diagnostics/work-orders',
    body: (c) => ({
      laboratoryAccessionId: UUID_ABSENT,
      custodianTenantId: c.tenantId,
      tests: [
        {
          serviceRequestId: c.vars.clinServiceRequestId ?? UUID_ABSENT,
          testCodeConceptId: CID,
        },
      ],
    }),
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/analyzer-runs',
    name: 'límite: sin auth',
    method: 'post',
    path: () => '/diagnostics/analyzer-runs',
    auth: false,
    body: () => ({
      analyzerDeviceId: UUID_ABSENT,
      runIdentifier: 'R-1',
      custodianTenantId: UUID_ABSENT,
    }),
    expectedStatus: 401,
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/analyzer-runs',
    name: 'límite: validación (falta runIdentifier)',
    method: 'post',
    path: (c) => '/diagnostics/analyzer-runs',
    body: (c) => ({
      analyzerDeviceId: UUID_ABSENT,
      custodianTenantId: c.tenantId,
    }),
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/analyzer-runs/{id}/messages',
    name: 'límite: corrida inexistente',
    method: 'post',
    path: () => `/diagnostics/analyzer-runs/${UUID_ABSENT}/messages`,
    body: () => ({ payloadHash: 'h1' }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/results/{observationId}/verifications',
    name: 'happy: verificar (técnico)',
    method: 'post',
    path: (c) =>
      `/diagnostics/results/${c.vars.clinObservationId ?? c.vars.patientProfileId}/verifications`,
    body: (c) => ({
      level: 'TECHNICAL',
      verifiedByProfileId:
  ...
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/results/{observationId}/verifications',
    name: 'límite: validación (falta level)',
    method: 'post',
    path: (c) =>
      `/diagnostics/results/${c.vars.patientProfileId}/verifications`,
    body: (c) => ({
      verifiedByProfileId: c.vars.patientProfileId,
      custodianTenantId: c.tenantId,
    }),
    expectedStatus: 400,
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/reports/{reportId}/versions',
    name: 'happy: crear versión',
    method: 'post',
    path: (c) => `/diagnostics/reports/${c.vars.clinReportId}/versions`,
    body: (c) => ({
      custodianTenantId: c.tenantId,
      conclusionText: 'Hallazgos dentro de límites normales.',
      results: c.vars.clinObservationId
        ? [{ observationId: c.vars.clinObservationId }]
        : [],
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagReportVersionId = String(b.id);
    },
  },
  {
    module: 'Diagnostics',
    ...
    path: (c) => `/diagnostics/reports/${c.vars.clinReportId}/versions`,
    auth: false,
    body: (c) => ({ custodianTenantId: c.tenantId }),
    expectedStatus: 401,
  },
  ...
  // ---- UC-20-08: liberar versión --------------------------------------------
  {
    ...
    method: 'post',
    path: (c) =>
      `/diagnostics/reports/${c.vars.clinReportId}/versions/${c.vars.diagReportVersionId}/release`,
    body: () => ({ patientVisibility: 'VISIBLE' }),
    expectedStatus: 200,
  },
  {
    module: 'Diagnostics',
    ...
    method: 'post',
    path: (c) =>
      `/diagnostics/reports/${c.vars.clinReportId}/versions/${UUID_ABSENT}/release`,
    body: () => ({}),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/critical-results',
    name: 'happy: detectar crítico',
    method: 'post',
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagCriticalId = String(b.id);
    },
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/critical-results',
    name: 'límite: validación (falta observationId)',
    method: 'post',
    path: (c) => '/diagnostics/critical-results',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
      custodianTenantId: c.tenantId,
    }),
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/critical-results/{id}/acknowledge',
    name: 'happy: acusar recibo',
    method: 'post',
    path: (c) =>
      `/diagnostics/critical-results/${c.vars.diagCriticalId}/acknowledge`,
    body: (c) => ({
      acknowledgedByProfileId:
        c.vars.practitionerProfileId ?? c.vars.patientProfileId,
    }),
    expectedStatus: 200,
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/critical-results/{id}/acknowledge',
    name: 'límite: notificación inexistente',
    method: 'post',
    path: (c) => `/diagnostics/critical-results/${UUID_ABSENT}/acknowledge`,
    body: (c) => ({ acknowledgedByProfileId: c.vars.patientProfileId }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/imaging-endpoints',
    name: 'happy: alta de endpoint DICOM',
    method: 'post',
    path: () => '/diagnostics/imaging-endpoints',
    body: (c) => ({
      baseUri: 'https://pacs.example/dicomweb',
      tenantId: c.tenantId,
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagImagingEndpointId = String(b.id);
    },
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /dicomweb/studies',
    name: 'happy: ingestar estudio DICOM',
    method: 'post',
      ...
      series: [
        {
          ...
          instances: [
            {
              dicomSopInstanceUid: `1.2.840.${Date.now()}.1.1`,
              sopClassConceptId: CID,
            },
          ],
        },
      ],
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.diagImagingStudyId = String(b.id);
    },
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /dicomweb/studies',
    name: 'límite: endpoint inexistente',
    method: 'post',
    path: (c) => '/dicomweb/studies',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/clinical-media',
    name: 'límite: sin auth',
    method: 'post',
  ...
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/clinical-media',
    name: 'límite: validación (falta fileId)',
    method: 'post',
    path: (c) => '/diagnostics/clinical-media',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
      custodianTenantId: c.tenantId,
    }),
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/imaging-studies/{id}/dose-events',
    name: 'happy: registrar dosis',
    method: 'post',
    path: (c) =>
      `/diagnostics/imaging-studies/${c.vars.diagImagingStudyId}/dose-events`,
  ...
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/imaging-studies/{id}/dose-events',
    name: 'límite: estudio inexistente',
    method: 'post',
    path: () => `/diagnostics/imaging-studies/${UUID_ABSENT}/dose-events`,
    body: () => ({ doseLengthProduct: '1' }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/data-quality-events',
    name: 'happy: evento de calidad + provenance',
    method: 'post',
  ...
  },
  {
    module: 'Diagnostics',
    endpoint: 'POST /diagnostics/data-quality-events',
    name: 'límite: validación (falta ruleCode)',
    method: 'post',
    path: (c) => '/diagnostics/data-quality-events',
    body: (c) => ({
      targetId: c.vars.diagSpecimenId,
      custodianTenantId: c.tenantId,
    }),
