...
export const PROFILES_SMOKE: SmokeCase[] = [
  ...
  },
  {
    ...
    path: () => '/profiles/patients',
    auth: false,
    body: (c) => ({ patientCode: `PC-${c.u}-x` }),
    expectedStatus: 401,
  },
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients',
    name: 'límite: validación (patientCode faltante)',
    method: 'post',
    path: () => '/profiles/patients',
    body: () => ({ displayName: 'Sin código' }),
    expectedStatus: 400,
  },
  ...
  // ---- UC-05-02: vincular cuenta de portal ----------------------------------
  {
    ...
    body: (c) => ({
      ...
      email: `link-${c.u}@example.com`,
      password: 'Str0ng-Passw0rd!',
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.linkUserId = String(b.id);
    },
  },
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/persons/{personId}/account-links',
    name: 'happy: vincular cuenta',
    method: 'post',
    path: (c) => `/profiles/persons/${c.vars.personId}/account-links`,
    body: (c) => ({ userId: c.vars.linkUserId }),
    expectedStatus: 201,
  },
  {
    module: 'Profiles',
    ...
    method: 'post',
    path: () => `/profiles/persons/${UUID_ABSENT}/account-links`,
    body: (c) => ({ userId: c.adminUserId }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients/{profileId}/identity-links',
    name: 'happy: vincular identidad MPI',
    method: 'post',
    path: (c) => `/profiles/patients/${c.vars.patientProfileId}/identity-links`,
    body: (c) => ({
  ...
  },
  {
    ...
    method: 'post',
    path: (c) => `/profiles/patients/${UUID_ABSENT}/identity-links`,
    body: (c) => ({
      sourceTenantId: c.tenantId,
  ...
  // ---- UC-05-10: persona relacionada ----------------------------------------
  {
    ...
    method: 'post',
    path: (c) =>
      `/profiles/patients/${c.vars.patientProfileId}/related-persons`,
    body: () => ({ displayName: 'Contacto Uno', isEmergencyContact: true }),
    expectedStatus: 201,
  },
  {
    module: 'Profiles',
    ...
    name: 'límite: paciente inexistente',
    method: 'post',
    path: () => `/profiles/patients/${UUID_ABSENT}/related-persons`,
    body: () => ({ displayName: 'x' }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients/{profileId}/portal-proxies',
    name: 'límite: sin auth',
    method: 'post',
    path: (c) => `/profiles/patients/${c.vars.patientProfileId}/portal-proxies`,
    auth: false,
    body: (c) => ({
      proxyUserId: c.adminUserId,
      scopeValueSetId: UUID_ABSENT,
      legalBasisRecordId: UUID_ABSENT,
    }),
    expectedStatus: 401,
  },
  {
    ...
    name: 'límite: paciente inexistente',
    method: 'post',
    path: (c) => `/profiles/patients/${UUID_ABSENT}/portal-proxies`,
    body: (c) => ({
      proxyUserId: c.adminUserId,
      scopeValueSetId: UUID_ABSENT,
      legalBasisRecordId: UUID_ABSENT,
  ...
  // ---- UC-05-03: alta de profesional ----------------------------------------
  {
    ...
    name: 'happy: onboarding profesional',
    method: 'post',
  ...
  // ---- UC-05-04: autorización jurisdiccional --------------------------------
  {
    ...
    method: 'post',
    path: (c) =>
      `/profiles/practitioners/${c.vars.practitionerProfileId}/jurisdiction-authorizations`,
    body: (c) => ({
      licenseNumber: `LIC2-${c.u}`,
  ...
  },
  {
    ...
    method: 'post',
    path: () =>
      `/profiles/practitioners/${UUID_ABSENT}/jurisdiction-authorizations`,
    body: (c) => ({ licenseNumber: `LIC3-${c.u}` }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/credentials/{credentialId}/verify',
  ...
  // ---- UC-05-06: agregar especialidad ---------------------------------------
  {
    ...
    method: 'post',
    path: (c) =>
      `/profiles/practitioners/${c.vars.practitionerProfileId}/specialties`,
    body: () => ({ isPrimary: true, boardCertified: true }),
    expectedStatus: 201,
  },
  {
    module: 'Profiles',
    ...
    name: 'límite: profesional inexistente',
    method: 'post',
    path: () => `/profiles/practitioners/${UUID_ABSENT}/specialties`,
    body: () => ({}),
    expectedStatus: 404,
  },
  ...
  // ---- UC-05-08 / 09: fusión y reversión ------------------------------------
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients',
    name: 'setup: paciente sobreviviente',
    method: 'post',
    path: () => '/profiles/patients',
    body: (c) => ({
      patientCode: `PC-${c.u}-surv`,
      displayName: 'Superviviente',
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.survivorProfileId = String(b.profileId);
    },
  },
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients',
    name: 'setup: paciente perdedor',
    method: 'post',
    path: () => '/profiles/patients',
    body: (c) => ({ patientCode: `PC-${c.u}-lose`, displayName: 'Duplicado' }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.loserProfileId = String(b.profileId);
    },
  },
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients/merge',
    name: 'happy: fusionar pacientes',
    method: 'post',
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.mergeEventId = String(b.id);
    },
  },
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients/merge',
    name: 'límite: fusionar consigo mismo',
    method: 'post',
    path: () => '/profiles/patients/merge',
    body: (c) => ({
      survivingPatientProfileId: c.vars.survivorProfileId,
  ...
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients/merge/{eventId}/reverse',
    name: 'happy: revertir fusión',
    method: 'post',
    path: (c) => `/profiles/patients/merge/${c.vars.mergeEventId}/reverse`,
    body: () => ({}),
    expectedStatus: 201,
  },
  {
    ...
    method: 'post',
    path: () => `/profiles/patients/merge/${UUID_ABSENT}/reverse`,
    body: () => ({}),
    expectedStatus: 404,
  },
  ...
  // ---- UC-05-12: defunción / anonimización ----------------------------------
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/patients',
    name: 'setup: paciente para defunción',
    method: 'post',
    path: () => '/profiles/patients',
    body: (c) => ({ patientCode: `PC-${c.u}-dec`, displayName: 'Finado' }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.deceasePersonId = String(b.personId);
    },
  },
  {
    module: 'Profiles',
    endpoint: 'POST /profiles/persons/{personId}/decease',
    name: 'happy: registrar defunción',
    method: 'post',
    path: (c) => `/profiles/persons/${c.vars.deceasePersonId}/decease`,
    body: () => ({ anonymize: true }),
    expectedStatus: 200,
  },
  {
    ...
    name: 'límite: persona inexistente',
    method: 'post',
    path: () => `/profiles/persons/${UUID_ABSENT}/decease`,
    body: () => ({}),
    expectedStatus: 404,
  },
];
