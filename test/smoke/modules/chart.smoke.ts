...
export const CHART_SMOKE: SmokeCase[] = [
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes',
    name: 'happy: crear nota (borrador SOAP)',
    method: 'post',
    path: () => '/charts/notes',
    body: (c) => ({
  ...
  },
  {
    ...
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
      authorProfileId: c.vars.patientProfileId,
    }),
    expectedStatus: 401,
  },
  {
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes/versions/{versionId}/exam-findings',
    name: 'happy: registrar hallazgos',
    method: 'post',
    path: (c) =>
      `/charts/notes/versions/${c.vars.chartVersionId}/exam-findings`,
    body: () => ({
      findings: [{ isNormal: true, findingText: 'Auscultación normal' }],
      objectiveText: 'Sin hallazgos',
    }),
    expectedStatus: 201,
  },
  {
    ...
    method: 'post',
    path: () => `/charts/notes/versions/${UUID_ABSENT}/exam-findings`,
    body: () => ({ findings: [{ isNormal: true }] }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Chart',
    endpoint: 'PUT /charts/notes/{noteId}/versions',
    name: 'happy: nueva versión',
    method: 'put',
    path: (c) => `/charts/notes/${c.vars.chartNoteId}/versions`,
    body: (c) => ({
      authorProfileId: c.vars.practitionerProfileId ?? c.vars.patientProfileId,
  ...
  },
  {
    module: 'Chart',
    endpoint: 'PUT /charts/notes/{noteId}/versions',
    name: 'límite: nota inexistente',
    method: 'put',
    path: () => `/charts/notes/${UUID_ABSENT}/versions`,
    body: (c) => ({ authorProfileId: c.vars.patientProfileId }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes/{noteId}/versions/{versionId}/sign',
    name: 'happy: firmar versión',
    method: 'post',
    path: (c) =>
      `/charts/notes/${c.vars.chartNoteId}/versions/${c.vars.chartVersionId}/sign`,
    body: (c) => ({
      signerProfileId: c.vars.practitionerProfileId ?? c.vars.patientProfileId,
    }),
    expectedStatus: 201,
  },
  {
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes/{noteId}/versions/{versionId}/cosign',
  ...
  },
  {
    ...
    method: 'post',
    path: (c) =>
      `/charts/notes/${c.vars.chartNoteId}/versions/${UUID_ABSENT}/cosign`,
    body: (c) => ({ signerProfileId: c.adminUserId }),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes/versions/{versionId}/release',
    name: 'happy: liberar al paciente',
    method: 'post',
    path: (c) => `/charts/notes/versions/${c.vars.chartVersionId}/release`,
  ...
  },
  {
    ...
    name: 'límite: versión inexistente',
    method: 'post',
    path: () => `/charts/notes/versions/${UUID_ABSENT}/release`,
    body: () => ({}),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes/versions/{versionId}/withhold',
    name: 'happy: retener del paciente',
    method: 'post',
    path: (c) => `/charts/notes/versions/${c.vars.chartVersionId}/withhold`,
    body: () => ({ policyVersion: '1.0' }),
    expectedStatus: 201,
  },
  {
    ...
    name: 'límite: versión inexistente',
    method: 'post',
    path: () => `/charts/notes/versions/${UUID_ABSENT}/withhold`,
    body: () => ({}),
    expectedStatus: 404,
  },
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/notes/{noteId}/amendments',
    name: 'happy: enmendar nota',
    method: 'post',
    path: (c) => `/charts/notes/${c.vars.chartNoteId}/amendments`,
    body: (c) => ({
      authorProfileId: c.vars.practitionerProfileId ?? c.vars.patientProfileId,
  ...
  },
  {
    ...
    name: 'límite: nota inexistente',
    method: 'post',
    path: () => `/charts/notes/${UUID_ABSENT}/amendments`,
    body: (c) => ({
      authorProfileId: c.vars.patientProfileId,
      amendmentReasonText: 'x',
    }),
    expectedStatus: 404,
  },
  ...
  // ---- UC-15-09: documento gobernado (crea antes un archivo real) -----------
  {
    ...
    name: 'setup: archivo para documento',
    method: 'post',
    path: () => '/common/files',
    body: (c) => ({
    ...
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.chartFileId = String(b.id);
    },
  },
  {
    module: 'Chart',
    endpoint: 'POST /charts/documents',
    name: 'happy: adjuntar documento con archivo',
    method: 'post',
    ...
    body: (c) => ({
      ...
      files: [
        { fileId: c.vars.chartFileId, contentRole: 'PRIMARY', ordinal: 0 },
      ],
    }),
    expectedStatus: 201,
  },
  {
    module: 'Chart',
    endpoint: 'POST /charts/documents',
    name: 'happy: documento sin archivos',
    method: 'post',
    path: () => '/charts/documents',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
  ...
  },
  {
    module: 'Chart',
    endpoint: 'POST /charts/documents',
    name: 'límite: validación (falta title)',
    method: 'post',
    path: () => '/charts/documents',
    body: (c) => ({
      patientProfileId: c.vars.patientProfileId,
  ...
  {
    module: 'Chart',
    endpoint: 'POST /charts/care-plans',
    name: 'happy: crear plan con actividades',
    method: 'post',
    ...
    body: (c) => ({
      ...
      activities: [
        { detailText: 'Caminata diaria' },
        { detailText: 'Dieta hiposódica' },
      ],
    }),
    expectedStatus: 201,
    capture: (b, c) => {
      c.vars.chartPlanId = String(b.id);
    },
  },
  {
    module: 'Chart',
  ...
  {
    module: 'Chart',
    endpoint: 'PATCH /charts/care-plans/{planId}/activities/{activityId}',
    name: 'límite: plan inexistente',
    method: 'patch',
    path: () => `/charts/care-plans/${UUID_ABSENT}/activities/${UUID_ABSENT}`,
  ...
  },
  {
    ...
    method: 'patch',
    path: (c) =>
      `/charts/care-plans/${c.vars.chartPlanId}/activities/${UUID_ABSENT}`,
  ...
  },
  {
    ...
    name: 'límite: sin auth',
    method: 'post',
    path: () => `/charts/templates/${UUID_ABSENT}/assignments`,
    auth: false,
